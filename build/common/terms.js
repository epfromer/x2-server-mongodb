...
exports.hasTerms = exports.keyTerms = void 0;
...
function hasTerms(email) {
    for (const term of exports.keyTerms) {
        if (email.body.indexOf(term) >= 0 || email.subject.indexOf(term) >= 0)
            return true;
    }
    for (const term of keyNames) {
        if (email.body.indexOf(term) >= 0 ||
